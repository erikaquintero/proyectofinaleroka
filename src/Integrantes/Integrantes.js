...
<div className="container align-self-center mt-5">
   <div className="row">
      <div className="col-12 col-md-6">
            <img src="https://firebasestorage.googleapis.com/v0/b/spotify-f0929.appspot.com/o/Integrante%20Cesar%20Vampiro.jpg?alt=media&token=439d8324-3713-478f-89a1-9121445de9f5" alt="integrantes" className='img-fluid w-100 mt-2 shadow img_faseta' />

      </div>
      <div className="col-12 col-md-6">
            <h1 className="text-center parrafo_gambeta">CESAR VAMPIRO</h1>
            <p>Fue miembro de Maná entre 1991 y 1994. Con Maná, grabó el álbum «¿Dónde Jugarán Los Niños?» (1992). Muchas personas conocen su seudónimo de la canción «Me vale» que comienza con la frase «Échale Vampiro». Posteriormente dejó Maná y comenzó a tocar en Azul Violeta, con canciones como Solo por hoy y Tu luz entre otras.
            </p>
      </div>
   ...
   <div className="row">
      <div className="col-12 col-md-6">
            ...
            <img src="https://firebasestorage.googleapis.com/v0/b/spotify-f0929.appspot.com/o/Integrante%20Sergio%20Vallin.jpg?alt=media&token=44048970-407d-4bbc-bfdd-c7c2c966fc08" alt="integrantes" className="img-fluid w-100 mt-2 shadow img_faseta"/>
      </div>
      <div className="col-12 col-md-6">
            <h1 className="text-center parrafo_gambeta">SERGIO VALLIN</h1>
            <p className="mt-2">
      ...
      <div className="col-12 col-md-6">
            ...
            <img src="https://firebasestorage.googleapis.com/v0/b/spotify-f0929.appspot.com/o/integrante%20Alejandro%20Gonzales.jpg?alt=media&token=9485f140-95f8-49ec-806e-49dbff0b1d32" alt="integrantes" className="img-fluid w-100 mt-2 shadow img_faseta"/>
      </div>
      <div className="col-12 col-md-6">
            <h1 className="text-center parrafo_gambeta">ALEJANDRO GONZALES</h1>
            <p className="mt-2">
      ...
      <div className="col-12 col-md-6">
            ...
            <p className="mt-2">
            José Fernando Emilio Olvera Sierra Guadalajara, Jalisco 8 de diciembre de 1959, artísticamente conocido por el público como Fher Olvera o Fer es un cantante, guitarrista, armoniquista, compositor y músico mexicano, reconocido principalmente por ser el vocalista y líder de la banda de rock en español Maná
            </p>
      </div>
   </div>
